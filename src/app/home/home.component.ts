...
export class HomeComponent implements OnInit {
    ...
    getOperatorList() {
        ...
        this.api.getOperator(this.territory).subscribe((operatorResponce: any) => {
            this.operatorList = operatorResponce; this.operatorList = [
    ...
    getSelectServiceList() {
        let data = {
            operatorid: this.serviceData.operatorid,
            billerName: "" + "'" + this.selectedOperatorlist + "'" + ""
        };
        this.api.getSelectServiceList(data).subscribe((Response: any) => {
